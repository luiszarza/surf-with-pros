...
User.destroy_all
puts "Database cleaned"
user1 = User.create!(email: "john@gmail.com", encrypted_password: "abc123", first_name: "John")
Listing.create!(content: "As a surf teacher, my focus is on helping beginners learn the fundamentals of surfing in a safe and supportive environment. I provide personalized attention and constructive feedback to help you progress quickly and confidently.", location: "Bali", title: "Surfing in Bali", price: 20, user_id: user1.id)
user2 = User.create!(email: "eve@gmail.com", encrypted_password: "abc123", first_name: "Eve")
Listing.create!(content: "Join me for a surf lesson that blends mindfulness and movement, as we explore the beauty and power of the ocean. I'll guide you through techniques for building strength and balance, while cultivating a sense of calm and connection.", location: "Koh Samui", title: "Surfing in Koh Samui", price: 20, user_id: user2.id)
user3 = User.create!(email: "adam@gmail.com", encrypted_password: "abc123", first_name: "Adam")
Listing.create!(content: "With years of experience both in the water and in the classroom, I'm passionate about helping all levels of surfers achieve their goals. Whether you're looking to catch your first wave or refine your technique, I've got you covered.", location: "Los Angeles", title: "Surfing in Los Angeles", price: 20, user_id: user3.id)
user4 = User.create!(email: "luis@gmail.com", encrypted_password: "abc123", first_name: "Luis")
...
user5 = User.create!(email: "matt@gmail.com", encrypted_password: "abc123", first_name: "Matt")
...
user6 = User.create!(email: "fanny@gmail.com", encrypted_password: "abc123", first_name: "Fanny")
...
user7 = User.create!(email: "tom@gmail.com", encrypted_password: "abc123", first_name: "Tom")
...
user8 = User.create!(email: "ante@gmail.com", encrypted_password: "abc123", first_name: "Ante")
...
user9 = User.create!(email: "simon@gmail.com", encrypted_password: "abc123", first_name: "Simon")
...
user10 = User.create!(email: "robin@gmail.com", encrypted_password: "abc123", first_name: "Robin")
